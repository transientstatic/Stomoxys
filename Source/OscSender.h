...
class OscSender{
	public:
        ...
        //because this way, I can leave all my code untouched and toggle remotely.
        void enable(const bool inenable) { enabled = inenable; };
        bool isSending() { return enabled; };
...
private:
        ...
        std::unique_ptr<std::thread> send_task;
		void send_task_func(char* buf, int size);
